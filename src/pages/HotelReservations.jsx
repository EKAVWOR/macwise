...
import {
  MapPin, Mail, Phone, Hotel, Star, Bed, Coffee,
...
const Hotels = () => {
  const HERO_IMAGE = 'https://images.unsplash.com/photo-1566073771259-6a8506099945?w=1920&q=80';
  const MAIN_IMAGE = 'https://images.unsplash.com/photo-1551882547-ff40c63fe5fa?w=1200&q=80';
  

  const [formData, setFormData] = useState({
    name: '', email: '', phone: '', service: 'Hotel Reservations', details: '',
  });
  ...
  const handleSubmit = (e) => {
    ...
    const whatsappMessage = `*🏨 New Hotel Reservation Inquiry*
...
_Sent via Macwise Travels Website_`;
    ...
    setTimeout(() => {
      ...
      setTimeout(() => {
        setFormData({ name: '', email: '', phone: '', service: 'Hotel Reservations', details: '' });
  ...
  const benefits = [
    { icon: Hotel, title: 'Wide Selection', description: 'Choose from thousands of hotels worldwide across all categories.', gradient: 'from-[#7B2CBF] to-[#9D4EDD]' },
    { icon: Star, title: 'Premium Properties', description: 'Access to top-rated hotels and resorts with verified guest reviews.', gradient: 'from-[#FF8C42] to-[#FF6B1A]' },
    { icon: Bed, title: 'Best Rates', description: 'Negotiated rates and exclusive deals you won\'t find on other sites.', gradient: 'from-[#9D4EDD] to-[#FF8C42]' },
    { icon: Coffee, title: 'Added Perks', description: 'Complimentary upgrades, breakfast, and early check-in benefits.', gradient: 'from-[#7B2CBF] to-[#FF6B1A]' },
  ];

  const features = [
    'Luxury 5-Star Hotels',
    'Budget-Friendly Options',
    'Exclusive Rates & Discounts',
    ...
    <div className="min-h-screen bg-white">
      ...
      <section style={{ backgroundImage: `url(${HERO_IMAGE})` }}
        ...
        <motion.div animate={{ scale: [1, 1.1, 1] }} transition={{ duration: 3, repeat: Infinity }}
          ...
          <Hotel className="text-white/30" size={80} />
        </motion.div>
        ...
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}
          ...
          <h1 className="text-5xl md:text-7xl font-bold text-white mb-4 drop-shadow-2xl">Hotel Reservations</h1>
          <div className="flex items-center justify-center gap-2 text-white/90 text-lg">
            ...
            <span>/</span>
            <span className="text-[#FFD8A8]">Hotel Reservations</span>
          </div>
        </motion.div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            <div className="lg:col-span-2">
              <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }}
                ...
                <img src={MAIN_IMAGE} alt="Hotel Reservations" className="w-full h-[400px] md:h-[500px] object-cover" />
                ...
                <div className="absolute top-6 left-6 bg-white/95 backdrop-blur-sm px-4 py-2 rounded-full shadow-lg flex items-center gap-2">
                  <Star className="text-[#FF8C42]" size={18} />
                  <span className="text-gray-900 font-bold text-sm">Premium Stays</span>
                </div>
              </motion.div>
              ...
              <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }}
                ...
                <div className="space-y-4 text-gray-600 leading-relaxed">
                  <p className="text-lg">
                    Discover the perfect place to stay with <strong className="text-[#7B2CBF]">Macwise Travels & Tours Limited</strong>. We offer access to a global network of hotels—from luxury 5-star resorts to budget-friendly accommodations—ensuring you find the ideal match for your trip.
                  </p>
                  <p>
                    Whether you're booking a romantic getaway, family vacation, or business stay, our team negotiates exclusive rates and added perks like complimentary breakfast, room upgrades, and early check-ins on your behalf.
                  </p>
                  <p>
                    Rest easy knowing your accommodation is in good hands. Let us secure your dream stay today! 🏨
                  </p>
                </div>
              ...
              <div className="bg-gradient-to-br from-[#7B2CBF] to-[#1a0d2e] rounded-3xl p-8 text-white shadow-2xl relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <div className="space-y-4 mb-6">
                    ...
                    <a href={`https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent('Hello! I would like to book a hotel.')}`}
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div>
                  ...
                  <textarea name="details" value={formData.details} onChange={handleChange} rows="5"
                    placeholder="Tell us about your stay... (destination, check-in/out dates, number of guests, room preferences)"
      ...
      <section className="py-16 bg-gradient-to-r from-[#7B2CBF] via-[#9D4EDD] to-[#FF8C42] relative overflow-hidden">
        ...
        <div className="container mx-auto max-w-7xl px-4 relative text-center">
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            ...
            <h2 className="text-3xl md:text-5xl font-bold text-white mb-6">Find Your Perfect Stay</h2>
            <p className="text-white/90 text-lg mb-8 max-w-2xl mx-auto">
              Let us secure the best accommodation that fits your style and budget.
            </p>
            <div className="flex flex-wrap gap-4 justify-center">
              <a href={`https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent('Hello! I want to book a hotel.')}`}
