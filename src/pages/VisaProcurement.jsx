...
import {
  MapPin, Mail, Phone, FileCheck, Stamp, FileText, Globe,
  CheckCircle2, ArrowRight, Loader2, Award, Shield,
} from 'lucide-react';
...
const Visa = () => {
  const HERO_IMAGE = 'https://images.unsplash.com/photo-1554629947-334ff61d85dc?w=1920&q=80';
  const MAIN_IMAGE = 'https://images.unsplash.com/photo-1521295121783-8a321d551ad2?w=1200&q=80';
  

  const [formData, setFormData] = useState({
    name: '', email: '', phone: '', service: 'Visa Procurement', details: '',
  });
  ...
  const handleSubmit = (e) => {
    ...
    const whatsappMessage = `*📄 New Visa Procurement Inquiry*
...
_Sent via Macwise Travels Website_`;
    ...
    setTimeout(() => {
      ...
      setTimeout(() => {
        setFormData({ name: '', email: '', phone: '', service: 'Visa Procurement', details: '' });
  ...
  const benefits = [
    { icon: FileCheck, title: 'High Success Rate', description: 'Proven track record with successful visa approvals worldwide.', gradient: 'from-[#7B2CBF] to-[#9D4EDD]' },
    { icon: Stamp, title: 'Multiple Countries', description: 'Expert handling of visas for US, UK, Canada, EU and more.', gradient: 'from-[#FF8C42] to-[#FF6B1A]' },
    { icon: FileText, title: 'Document Mastery', description: 'Meticulous review and preparation of all required documents.', gradient: 'from-[#9D4EDD] to-[#FF8C42]' },
    { icon: Award, title: 'Refusal Recovery', description: 'Successfully reapply even after previous visa refusals.', gradient: 'from-[#7B2CBF] to-[#FF6B1A]' },
  ];

  const features = [
    'US, UK, Canada & Schengen Visas',
    ...
    <div className="min-h-screen bg-white">
      ...
      <section style={{ backgroundImage: `url(${HERO_IMAGE})` }}
        ...
        <motion.div animate={{ rotate: [0, 10, -10, 0] }} transition={{ duration: 4, repeat: Infinity }}
          ...
          <Stamp className="text-white/30" size={80} />
        </motion.div>
        ...
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}
          ...
          <h1 className="text-5xl md:text-7xl font-bold text-white mb-4 drop-shadow-2xl">Visa Procurement</h1>
          <div className="flex items-center justify-center gap-2 text-white/90 text-lg">
            ...
            <span>/</span>
            <span className="text-[#FFD8A8]">Visa Procurement</span>
          </div>
        </motion.div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            <div className="lg:col-span-2">
              <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }}
                ...
                <img src={MAIN_IMAGE} alt="Visa Procurement" className="w-full h-[400px] md:h-[500px] object-cover" />
                ...
                <div className="absolute top-6 left-6 bg-white/95 backdrop-blur-sm px-4 py-2 rounded-full shadow-lg flex items-center gap-2">
                  <FileCheck className="text-[#FF8C42]" size={18} />
                  <span className="text-gray-900 font-bold text-sm">Trusted Experts</span>
                </div>
              </motion.div>
              ...
              <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }}
                ...
                <div className="space-y-4 text-gray-600 leading-relaxed">
                  <p className="text-lg">
                    Navigating visa applications can be overwhelming—but not with <strong className="text-[#7B2CBF]">Macwise Travels & Tours Limited</strong>. With years of expertise and a strong track record, we make the visa procurement process simple, fast, and stress-free for individuals and businesses.
                  </p>
                  <p>
                    From the US, UK, Canada, Schengen states, China, UAE, and more—we provide expert guidance on documentation, application reviews, and embassy submissions. We've helped clients successfully obtain visas even after multiple previous refusals.
                  </p>
                  <p>
                    Trust the experts. Let us handle your visa application from start to finish! 📄
                  </p>
                </div>
              ...
              <div className="bg-gradient-to-br from-[#7B2CBF] to-[#1a0d2e] rounded-3xl p-8 text-white shadow-2xl relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <div className="space-y-4 mb-6">
                    ...
                    <a href={`https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent('Hello! I need help with a visa application.')}`}
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div>
                  ...
                  <textarea name="details" value={formData.details} onChange={handleChange} rows="5"
                    placeholder="Tell us about your visa needs... (destination country, visa type, travel purpose, timeline)"
      ...
      <section className="py-16 bg-gradient-to-r from-[#7B2CBF] via-[#9D4EDD] to-[#FF8C42] relative overflow-hidden">
        ...
        <div className="container mx-auto max-w-7xl px-4 relative text-center">
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            ...
            <h2 className="text-3xl md:text-5xl font-bold text-white mb-6">Get Your Visa Approved</h2>
            <p className="text-white/90 text-lg mb-8 max-w-2xl mx-auto">
              Let our expert team handle your visa application from start to finish.
            </p>
            <div className="flex flex-wrap gap-4 justify-center">
              <a href={`https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent('Hello! I need a visa.')}`}
