...
import {
  MapPin, Mail, Phone, Shield, Heart, Umbrella, Lock,
  CheckCircle2, ArrowRight, Loader2, Award,
} from 'lucide-react';
...
const Insurance = () => {
  ...
  const MAIN_IMAGE = 'https://images.unsplash.com/photo-1556742044-3c52d6e88c62?w=1200&q=80';
  

  const [formData, setFormData] = useState({
    name: '', email: '', phone: '', service: 'Travel Insurance', details: '',
  });
  ...
  const handleSubmit = (e) => {
    ...
    const whatsappMessage = `*🛡️ New Travel Insurance Inquiry*
...
_Sent via Macwise Travels Website_`;
    ...
    setTimeout(() => {
      ...
      setTimeout(() => {
        setFormData({ name: '', email: '', phone: '', service: 'Travel Insurance', details: '' });
  ...
  const benefits = [
    { icon: Shield, title: 'Full Protection', description: 'Comprehensive coverage for every aspect of your journey.', gradient: 'from-[#7B2CBF] to-[#9D4EDD]' },
    { icon: Heart, title: 'Medical Coverage', description: 'Worldwide medical emergency support including hospitalization.', gradient: 'from-[#FF8C42] to-[#FF6B1A]' },
    { icon: Umbrella, title: 'Trip Protection', description: 'Get reimbursed for cancellations, delays, and interruptions.', gradient: 'from-[#9D4EDD] to-[#FF8C42]' },
    { icon: Lock, title: 'Secure & Trusted', description: 'Partnered with top insurance providers for reliable coverage.', gradient: 'from-[#7B2CBF] to-[#FF6B1A]' },
  ];
    ...
    <div className="min-h-screen bg-white">
      ...
      <section style={{ backgroundImage: `url(${HERO_IMAGE})` }}
        ...
        <motion.div animate={{ y: [0, -15, 0] }} transition={{ duration: 3, repeat: Infinity }}
          ...
          <Shield className="text-white/30" size={80} />
        </motion.div>
        ...
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}
          ...
          <h1 className="text-5xl md:text-7xl font-bold text-white mb-4 drop-shadow-2xl">Travel Insurance</h1>
          <div className="flex items-center justify-center gap-2 text-white/90 text-lg">
            ...
            <span>/</span>
            <span className="text-[#FFD8A8]">Travel Insurance</span>
          </div>
        </motion.div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            <div className="lg:col-span-2">
              <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }}
                ...
                <img src={MAIN_IMAGE} alt="Travel Insurance" className="w-full h-[400px] md:h-[500px] object-cover" />
                ...
                <div className="absolute top-6 left-6 bg-white/95 backdrop-blur-sm px-4 py-2 rounded-full shadow-lg flex items-center gap-2">
                  <Shield className="text-[#FF8C42]" size={18} />
                  <span className="text-gray-900 font-bold text-sm">Fully Protected</span>
                </div>
              </motion.div>
              ...
              <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }}
                ...
                <div className="space-y-4 text-gray-600 leading-relaxed">
                  <p className="text-lg">
                    Travel with confidence knowing you're protected. <strong className="text-[#7B2CBF]">Macwise Travels & Tours Limited</strong> offers comprehensive travel insurance plans that cover medical emergencies, trip cancellations, lost baggage, flight delays, and more.
                  </p>
                  <p>
                    We partner with leading insurance providers to bring you affordable, reliable coverage tailored to your trip duration and destination. Our experts help you choose the right policy so there are no surprises during your travels.
                  </p>
                  <p>
                    Don't let unexpected events ruin your travels. Get covered today and enjoy worry-free journeys! 🛡️
                  </p>
                </div>
              ...
              <div className="bg-gradient-to-br from-[#7B2CBF] to-[#1a0d2e] rounded-3xl p-8 text-white shadow-2xl relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <div className="space-y-4 mb-6">
                    ...
                    <a href={`https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent('Hello! I need travel insurance.')}`}
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div>
                  ...
                  <textarea name="details" value={formData.details} onChange={handleChange} rows="5"
                    placeholder="Tell us about your travel plans... (destination, trip duration, number of travelers, coverage needs)"
      ...
      <section className="py-16 bg-gradient-to-r from-[#7B2CBF] via-[#9D4EDD] to-[#FF8C42] relative overflow-hidden">
        ...
        <div className="container mx-auto max-w-7xl px-4 relative text-center">
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            ...
            <h2 className="text-3xl md:text-5xl font-bold text-white mb-6">Get Protected Today</h2>
            <p className="text-white/90 text-lg mb-8 max-w-2xl mx-auto">
              Don't travel without insurance. Peace of mind is just a few clicks away.
            </p>
            <div className="flex flex-wrap gap-4 justify-center">
              <a href={`https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent('Hello! I want travel insurance.')}`}
