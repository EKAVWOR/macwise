...
import {
  MapPin, Mail, Phone, Plane, Globe, Clock, Shield,
  CheckCircle2, ArrowRight, Loader2, Headphones, Tag, Award,
} from 'lucide-react';
...
const Flight = () => {
  // ── Online Images ─────────────────────────────────────────
  const HERO_IMAGE = 'https://images.unsplash.com/photo-1436491865332-7a61a109cc05?w=1920&q=80';
  const MAIN_IMAGE = 'https://images.unsplash.com/photo-1569629743817-70d8db6c323b?w=1200&q=80';
  

  // ── Form State ────────────────────────────────────────────
  const [formData, setFormData] = useState({
    name: '', email: '', phone: '', service: 'Flight Booking', details: '',
  });
  const [isSubmitting, setIsSubmitting] = useState(false);
  const [isSubmitted, setIsSubmitted] = useState(false);

  // ✅ UPDATED WhatsApp Number: +234 805 267 6836
  ...
  const handleSubmit = (e) => {
    ...
    const whatsappMessage = `*✈️ New Flight Booking Inquiry*
...
_Sent via Macwise Travels Website_`;
    ...
    setTimeout(() => {
      ...
      setTimeout(() => {
        setFormData({ name: '', email: '', phone: '', service: 'Flight Booking', details: '' });
  ...
  const benefits = [
    { icon: Globe, title: 'Global Airlines Network', description: 'Connect with top international and domestic airlines worldwide.', gradient: 'from-[#7B2CBF] to-[#9D4EDD]' },
    { icon: Tag, title: 'Best Price Guarantee', description: 'Exclusive deals and competitive rates you won\'t find elsewhere.', gradient: 'from-[#FF8C42] to-[#FF6B1A]' },
    { icon: Clock, title: 'Real-Time Updates', description: 'Stay informed with instant notifications on flight status changes.', gradient: 'from-[#9D4EDD] to-[#FF8C42]' },
    { icon: Headphones, title: '24/7 Customer Support', description: 'Our dedicated team is available around the clock to assist you.', gradient: 'from-[#7B2CBF] to-[#FF6B1A]' },
  ];
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      >
        ...
        >
          <Plane className="text-white/30" size={80} />
        </motion.div>
        ...
        >
          ...
          <div className="flex items-center justify-center gap-2 text-white/90 text-lg">
            ...
            <span>/</span>
            <span className="text-[#FFD8A8]">Flight Bookings</span>
          </div>
        </motion.div>
      </section>
        ...
        <div className="container mx-auto max-w-7xl px-4 relative">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            <div className="lg:col-span-2">
              ...
              >
                <img src={MAIN_IMAGE} alt="Flight Bookings" className="w-full h-[400px] md:h-[500px] object-cover" />
                ...
                <div className="absolute top-6 left-6 bg-white/95 backdrop-blur-sm px-4 py-2 rounded-full shadow-lg flex items-center gap-2">
                  <Plane className="text-[#FF8C42]" size={18} />
                  <span className="text-gray-900 font-bold text-sm">Premium Service</span>
                </div>
              </motion.div>
              ...
              >
                ...
                <div className="space-y-4 text-gray-600 leading-relaxed">
                  <p className="text-lg">
                    Booking flights has never been easier with{' '}
                    <strong className="text-[#7B2CBF]">Macwise Travels & Tours Limited</strong>.
                    Whether you are traveling for business or leisure, we offer seamless domestic and international flight bookings at competitive rates.
                  </p>
                  <p>
                    Choosing Macwise Travels means enjoying personalized service, expert guidance, and 24/7 support. We ensure you get the best deals, exclusive discounts, and smooth travel arrangements.
                  </p>
                  <p>
                    Let us handle your travel plans while you focus on your journey. Fill out our consultation form and let us secure the best flights for you today! ✈️
                  </p>
                </div>
                  ...
                  <div className="space-y-4 mb-6">
                    ...
                    <a href="mailto:Macwiseltd@gmail.com" className="flex items-start gap-3 group">
                      ...
                      <div className="text-sm">
                        ...
                        <p className="text-white/80 text-xs group-hover:text-[#FFD8A8] transition-colors break-all">
                    ...
                    <a href="tel:+2348052676836" className="flex items-start gap-3 group">
                      ...
                      <div className="text-sm">
                        ...
                        <p className="text-white/80 text-xs group-hover:text-[#FFD8A8] transition-colors">
                          +234 805 267 6836
                        </p>
                      </div>
                    </a>
                    ...
                    <a
                      href={`https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent('Hello! I would like to book a flight.')}`}
                      target="_blank"
            ...
            <div className="bg-white rounded-3xl p-8 md:p-12">
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div>
                  ...
                  <textarea
                    name="details" value={formData.details} onChange={handleChange} rows="5"
                    placeholder="Tell us about your travel plans..."
                    className="w-full px-4 py-3 rounded-xl bg-gray-50 border-2 border-gray-200 focus:outline-none focus:border-[#FF8C42] focus:ring-2 focus:ring-[#FF8C42]/20 focus:bg-white transition-all resize-none"
                  ></textarea>
                </div>
                ...
                >
                  {isSubmitting ? (
                    <><Loader2 size={22} className="animate-spin" />Sending Your Request...</>
                  ) : isSubmitted ? (
                    <><CheckCircle2 size={22} />Opening WhatsApp...</>
                  ) : (
      ...
      <section className="py-16 bg-gradient-to-r from-[#7B2CBF] via-[#9D4EDD] to-[#FF8C42] relative overflow-hidden">
        ...
        <div className="container mx-auto max-w-7xl px-4 relative text-center">
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            ...
            <h2 className="text-3xl md:text-5xl font-bold text-white mb-6">Ready to Take Off?</h2>
            <p className="text-white/90 text-lg mb-8 max-w-2xl mx-auto">
              Let our experts handle your flight bookings while you focus on creating unforgettable memories.
            </p>
            <div className="flex flex-wrap gap-4 justify-center">
              <a
                href={`https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent('Hello! I want to book a flight.')}`}
